<nav class="navbar is-fixed-top is-transparent" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
        ...
        <a role="button" class="navbar-burger burger has-text-white" aria-label="menu" aria-expanded="false" data-target="Main_Nav">
                ...
                <div class="buttons">
                    ...
                    if ($_SERVER['REQUEST_URI'] === "/shop/login") {
                        ...
                        if ($_SESSION['is_admin'] === 1){
                            echo '<a href="/admin" class="button is-primary"><strong>จัดการระบบ</strong></a>';
                        }
